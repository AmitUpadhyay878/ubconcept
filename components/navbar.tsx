...
import HireUsModal from "./HireModal";
  ...
  return (
    ...
    >
      ...
      <div className="hidden lg:flex items-center space-x-10">
        ...
        <Button
          aria-label="Hire-us"
          onClick={() => setOpenHireusModal(true)}
          size="lg"
          variant="outline"
          className="text-white border-amber-500 hover:bg-amber-500/20"
        >
          Hire Us
        </Button>
      ...
      {mobileMenuOpen && (
        ...
        <HireUsModal open={openHireusModal} onOpenChange={setOpenHireusModal} />
